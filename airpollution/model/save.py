...
def createBlobContainer(blob_service_client, localFile, containerName = "model-container"):
    ...
    suffix += 1
    container_name = str(containerName + "-" + str(suffix))
    ...
    upload_file_path = os.path.join(".", localFile)

    # Create a blob client using the local file name as the name for the blob
    blob_client = blob_service_client.get_blob_client(container=container_name, blob=localFile)
